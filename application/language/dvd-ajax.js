...
function manageRow(data) {
    ...
    $.each( data, function( key, value ) {
        ...
        rows = rows + '<td>'+value.titreD+'</td>';

        rows = rows + '<td>'+value.auteurD+'</td>';
...
$(".crud-submit").click(function(e){
    ...
    var form_action = $("#create-dvd").find("form").attr("action");

    var title = $("#create-dvd").find("input[name='title']").val();
